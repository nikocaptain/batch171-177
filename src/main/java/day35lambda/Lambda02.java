...
public class Lambda02 {
    public static void main(String[] args) {
       ...
       // removeIfLengthGreaterThanFive(myList);
        //removeIfElementsStrarWithZorEndsWithf(myList);
       removeIfElementsStrarWithZorEndsWithf2(myList);
    ...
    //1. yol
    public static void removeIfElementsStrarWithZorEndsWithf(List<String> myList){
        myList.removeIf(t->t.charAt(0)=='Z'||t.charAt(t.length()-1)=='f');
        System.out.println(myList);
    }
    //2. yol
    public static void removeIfElementsStrarWithZorEndsWithf2(List<String> myList){
